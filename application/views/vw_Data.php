                  ...
                  <div class="x_content">
                      <form id="post_" data-parsley-validate class="form-horizontal form-label-left">
                        <div class="item form-group">
                          <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nama Warga <span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 ">
                            <input type="text" name="Nama" id="Nama" required="" placeholder="Nama Warga" class="form-control ">
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 ">
                            ...
                            <select name="Pekerjaan" id="Pekerjaan" class="form-control">
                              ...
                              <option value="3">Buruh Lepas</option>
                        ...
                        <div class="item form-group">
                          <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Penghasilan<span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 ">
                            <input type="number" name="Penghasilan" id="Penghasilan" required="" placeholder="Penghasilan" class="form-control " >
                          </div>
                        </div>
                        <div class="item form-group">
      ...
      $.ajax({
            ...
            success: function (response) {
              $.each(response.data,function (k,v) {
                ...
                $('#Pekerjaan').val(v.Pekerjaan);
                $('#Penghasilan').val(v.Penghasilan);
                $('#Pendidikan').val(v.Pendidikan);
