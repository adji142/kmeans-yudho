...
class C_Proses extends CI_Controller {
	...
	public function getHasil()
	{
		...
		$SQL = "SELECT 
					a.keanggotaan, b.*,
					CASE WHEN a.Keanggotaan = 'C1' THEN 'BANYAK' ELSE CASE WHEN a.Keanggotaan = 'C2' THEN 'SEDANG' ELSE CASE WHEN a.Keanggotaan = 'C3' THEN 'SEDIKIT' ELSE '' END END END Kelompok
				FROM thasil a
